# Demo Webshop Playwright Typescript Framework
...
## Introduction
Senior ‌‌‌‌‌QA Engineer‌‌‌‌ position at Bamboo Card/Incenti DMCC | Technical Assessment.
...
```bash
git clone https://github.com/avidcutlet/Demo_Web_Shop-Playwright_Typescript_Framework.git
```

2. Go to project directory:
```bash
cd Demo_Web_Shop-Playwright_Typescript_Framework
```
...
```bash
npm run test:chromium /ui/place-order-with-multiple-products-functionality-ui.spec.ts
```

To run a specific test spec using firefox, use the following commands:
```bash
npm run test:firefox /ui/place-order-with-multiple-products-functionality-ui.spec.ts
```

To run a specific test spec using edge, use the following commands:
```bash
npm run test:edge /ui/place-order-with-multiple-products-functionality-ui.spec.ts
```

To run a specific test spec using webkit, use the following commands:
```bash
npm run test:webkit /ui/place-order-with-multiple-products-functionality-ui.spec.ts
```
...
To run a specific tag using chromium, use the following commands:
```bash
npm run test:chromium:tag "@TS1|@TS2|@TS3"
```

To run a specific tag using firefox, use the following commands:
```bash
npm run test:firefox:tag "@TS1|@TS2|@TS3"
```

To run a specific tag using edge, use the following commands:
```bash
npm run test:edge:tag "@TS1|@TS2|@TS3"
```

To run a specific tag using webkit, use the following commands:
```bash
npm run test:webkit:tag "@TS1|@TS2|@TS3"
```
